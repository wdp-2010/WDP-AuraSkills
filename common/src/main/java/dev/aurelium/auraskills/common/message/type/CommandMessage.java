...
public enum CommandMessage implements MessageKey {
    ...
    VERSION_VERSION,
    VERSION_NEW_UPDATE(Command.VERSION, "new_update"),
    XP_ADD_ADDED,
    XP_SET_SET,
    XP_REMOVE_REMOVED,
    ...
    SHOP_SELL_COOLDOWN,
    SHOP_BUY_SUCCESS,
    SHOP_BUY_OUT_OF_STOCK,
    SHOP_BUY_INSUFFICIENT_COINS,
    SHOP_BUY_ITEM_NOT_FOUND,
    SHOP_BUY_ERROR,
    SHOP_LEVEL_SUCCESS,
    SHOP_LEVEL_INSUFFICIENT_COINS,
    SHOP_LEVEL_MAX_LEVEL,
    SHOP_LEVEL_ERROR,
    SHOP_ABILITY_PURCHASE_SUCCESS,
    SHOP_ABILITY_INSUFFICIENT_LEVEL,
    SHOP_COOLDOWN_EXPIRED,
    SHOP_COOLDOWN_TRACKER_TITLE,
    SHOP_COOLDOWN_TRACKER_ITEM_LORE,
    SHOP_COOLDOWN_TRACKER_NO_COOLDOWNS;
